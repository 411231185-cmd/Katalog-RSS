# Технико-коммерческое предложение (ТКП) на станок RT755F3
...
<!-- AUTO:BEGIN SOURCE -->
- Источник описания/ТТХ: `..\..\Станки\rt755f3.md`
...
<!-- AUTO:BEGIN TTH -->
- Наибольший диаметр обрабатываемой детали: 800 мм
- Мощность главного двигателя: 37 кВт
- Наибольшая длина обрабатываемой детали (РМЦ): 1500-10000 мм
