# Технико-коммерческое предложение (ТКП) на станок RT5001
...
<!-- AUTO:BEGIN SOURCE -->
- Источник описания/ТТХ: `..\..\Станки\rt5001.md`
...
<!-- AUTO:BEGIN TTH -->
- Наибольший диаметр обрабатываемой детали: 1100 мм (колеса)
- Мощность главного двигателя: 30 кВт
- Наибольшая длина обрабатываемой детали (РМЦ): спец
