# Технико-коммерческое предложение (ТКП) на станок 16P25
...
<!-- AUTO:BEGIN SOURCE -->
- Источник описания/ТТХ: `..\..\Станки\16p25.md`
...
<!-- AUTO:BEGIN TTH -->
- Наибольший диаметр обрабатываемой детали: 500 мм
- Мощность главного двигателя: 11 кВт
- Наибольшая длина обрабатываемой детали (РМЦ): 750-2000 мм
